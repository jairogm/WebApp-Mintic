...
const BuscarVentaPopup = ({ isOpen, WasFound, close, data}) => {
                ...
                <div className="gest-usu-pop-modal__dialog" onClick={handleModalDialogClick}>
                    <div className="gest-usu-pop-update-box">
                        ...
                        <div className="gest-usu-pop-update-box-buttons">
                            <button className="gest-usu-pop-btn gest-usu-pop-btn-update" style={{color:"white"}} onClick={() =>close(true)}>Cambiar Datos</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default BuscarVentaPopup;